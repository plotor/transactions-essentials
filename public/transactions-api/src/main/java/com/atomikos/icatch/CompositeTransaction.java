...
public interface CompositeTransaction {
     ...
     *
     * @throws HeurMixedException  On heuristic mixed outcome.
     * @throws SysException        For unexpected failures.
     * @throws SecurityException   If calling thread does not have
     *                             right to commit.
     * @throws HeurHazardException In case of heuristic hazard.
     * @throws RollbackException   If the transaction was rolled back.
     */
     ...
     *
     * @throws IllegalStateException If prepared or inactive.
     * @throws SysException          If unexpected error.
     */
     ...
     *
     * @throws IllegalStateException If  called for non-root tx.
     * @throws SysException          For unexpected errors.
     */
