...
public interface Participant {
     ...
     * @throws HeuristicRollbackException If the participant has rolled back.
     * @throws HeuristicMixedException    If part of it was rolled back.
     * @throws HeurHazardException        On possible conflicts.
     * @throws RollbackException          In case of one-phase commit,
     ...
     * of this method.
     *
     * @throws HeurCommitException If the participant committed.
     * @throws HeurHazardException If the participant's final state
     *                             is unsure.
     * @throws HeurMixedException  If part of the work was rolled back.
     * @throws SysException
     */
