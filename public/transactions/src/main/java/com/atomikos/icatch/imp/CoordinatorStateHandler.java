...
abstract class CoordinatorStateHandler {
     ...
     *
     * @param coordinator The coordinator to represent.
     */
     ...
     *
     * @param other The previous instance whose attributes should be used.
     */
     ...
     *
     * @param heuristic True iff a heuristic commit should be done.
     * @param onePhase True iff one-phase commit.
     */
     ...
     *
     * @param indoubt True iff some participants may already have voted YES.
     * @param heuristic True iff a heuristic rollback should be done.
     */
